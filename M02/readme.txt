...
1.	In the main method create 3 students with the same names names using second constructor
...
Task2: Goal of the task is to get acquainted with Array.Sort, Stopwatch and System.Diagnostics.Process.
